    ...
    const adminToolsTabs = [
...

      {
        ...
        columns: [
          ...
          { key: 'output', label: 'Output Data', width: '30%' },
          { key: 'downloadCsv', label: 'Download CSV' },
          { key: 'errorDetails', label: 'Details' }
        ],
        rows: [
          ...
          { eventId: 'EVT-902109', eventDate: '2026-02-27 14:12', creationMode: 'Wix Only', fileName: 'wix_assign_44.csv', status: 'Completed with Errors', output: '223/250 created, 27 failed website mapping.', downloadCsv: 'exports/evt-902109-results.csv', errorDetails: ['Row 14: Website ID not found', 'Row 39: Owner Account ID mismatch', 'Row 88: Contributor Account ID invalid format'] },
          { eventId: 'EVT-902108', eventDate: '2026-02-27 13:05', creationMode: 'BAS Portal', fileName: 'portal_seed_11.csv', status: 'Completed', output: '120/120 created in BAS portal.', downloadCsv: 'exports/evt-902108-results.csv' },
          { eventId: 'EVT-902107', eventDate: '2026-02-27 11:39', creationMode: 'BAS + Wix', fileName: 'enterprise_wave2.csv', status: 'Failed Validation', output: 'Pre-assessment failed: 73 invalid rows.', downloadCsv: 'exports/evt-902107-results.csv', errorDetails: ['Row 83: Missing Website Name', 'Row 111: Advisor Name below minimum length', 'Row 126: Date Created invalid format'] },
          ...
          { eventId: 'EVT-902099', eventDate: '2026-02-26 10:10', creationMode: 'BAS + Wix', fileName: 'legacy_siteadmin_wave.csv', status: 'Completed with Errors', output: '467/500 processed, 33 account mismatches.', downloadCsv: 'exports/evt-902099-results.csv', errorDetails: ['Row 5: BAS Account ID missing', 'Row 73: Account Affiliation not found', 'Row 204: Site ID not linked to owner account'] }
        ]
      },
      {
        name: 'Calculators',
