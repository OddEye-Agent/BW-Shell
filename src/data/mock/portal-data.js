...
const accountRows = [
    ...
    const adminToolsTabs = [
...

      {
        ...
        rows: [
          { eventId: 'EVT-902110', eventDate: '2026-02-27 15:41', uploadedBy: 'Sean Admin', creationMode: 'BAS + Wix', fileName: 'advisor_batch_01.csv', status: 'Completed', output: '250/250 created. Notifications suppressed.', downloadCsv: 'exports/evt-902110-results.csv' },
          { eventId: 'EVT-902109', eventDate: '2026-02-27 14:12', uploadedBy: 'Greg Mallett', creationMode: 'Wix Only', fileName: 'wix_assign_44.csv', status: 'Completed with Errors', output: '223/250 created, 27 failed website mapping.', downloadCsv: 'exports/evt-902109-results.csv', errorDetails: ['Row 14: Website ID not found', 'Row 22: Advisor Email missing', 'Row 39: Owner Account ID mismatch', 'Row 57: Duplicate contributor assignment', 'Row 88: Contributor Account ID invalid format', 'Row 119: Role not allowed for account', 'Row 147: Submission category missing'] },
          { eventId: 'EVT-902108', eventDate: '2026-02-27 13:05', uploadedBy: 'Amy Peterson', creationMode: 'BAS Portal', fileName: 'portal_seed_11.csv', status: 'Completed', output: '120/120 created in BAS portal.', downloadCsv: 'exports/evt-902108-results.csv' },
          { eventId: 'EVT-902107', eventDate: '2026-02-27 11:39', uploadedBy: 'Yoshi Sales', creationMode: 'BAS + Wix', fileName: 'enterprise_wave2.csv', status: 'Failed Validation', output: 'Pre-assessment failed: 73 invalid rows.', downloadCsv: 'exports/evt-902107-results.csv', errorDetails: ['Row 12: Missing Advisor Email', 'Row 31: User Status invalid value', 'Row 48: Account Affiliation not found', 'Row 83: Missing Website Name', 'Row 97: Site ID malformed', 'Row 111: Advisor Name below minimum length', 'Row 126: Date Created invalid format'] },
          { eventId: 'EVT-902106', eventDate: '2026-02-27 10:18', uploadedBy: 'Bob Jones', creationMode: 'BAS + Wix', fileName: 'enterprise_wave1.csv', status: 'Completed', output: '500/500 created and assigned.', downloadCsv: 'exports/evt-902106-results.csv' },
          { eventId: 'EVT-902105', eventDate: '2026-02-26 18:52', uploadedBy: 'Jane Mitchell', creationMode: 'Wix Only', fileName: 'wix_fixup_07.csv', status: 'Completed with Errors', output: '186/200 created, 14 permission collisions.', downloadCsv: 'exports/evt-902105-results.csv', errorDetails: ['Row 9: Role not permitted for account', 'Row 26: Website folder not accessible', 'Row 41: Owner Account ID inactive', 'Row 62: Duplicate advisor email', 'Row 84: Contributor account not linked', 'Row 113: Publish flag invalid', 'Row 131: Website assignment denied'] },
          { eventId: 'EVT-902104', eventDate: '2026-02-26 17:31', uploadedBy: 'Lana Core', creationMode: 'BAS Portal', fileName: 'retail_batch_b.csv', status: 'Completed', output: '300/300 created in BAS portal.', downloadCsv: 'exports/evt-902104-results.csv' },
          { eventId: 'EVT-902103', eventDate: '2026-02-26 16:07', uploadedBy: 'Nora Vale', creationMode: 'BAS + Wix', fileName: 'retail_batch_a.csv', status: 'Processing', output: 'Batch accepted, processing in queue. (Server retry advised)', downloadCsv: 'exports/evt-902103-results.csv' },
          { eventId: 'EVT-902102', eventDate: '2026-02-26 14:44', uploadedBy: 'Tom Ridge', creationMode: 'BAS + Wix', fileName: 'advisor_migration_9.csv', status: 'Completed', output: '249/249 created.', downloadCsv: 'exports/evt-902102-results.csv' },
          { eventId: 'EVT-902101', eventDate: '2026-02-26 13:19', uploadedBy: 'Eva Cruz', creationMode: 'BAS Portal', fileName: 'program_admin_seed.csv', status: 'Completed', output: '42/42 created and role-bound.', downloadCsv: 'exports/evt-902101-results.csv' },
          { eventId: 'EVT-902100', eventDate: '2026-02-26 11:55', uploadedBy: 'Mia Chen', creationMode: 'Wix Only', fileName: 'wix_site_bindings.csv', status: 'Completed', output: '88/88 assigned to websites.', downloadCsv: 'exports/evt-902100-results.csv' },
          { eventId: 'EVT-902099', eventDate: '2026-02-26 10:10', uploadedBy: 'Arjun Patel', creationMode: 'BAS + Wix', fileName: 'legacy_siteadmin_wave.csv', status: 'Completed with Errors', output: '467/500 processed, 33 account mismatches.', downloadCsv: 'exports/evt-902099-results.csv', errorDetails: ['Row 5: BAS Account ID missing', 'Row 27: Advisor Name empty', 'Row 54: Invalid Broadforce ID', 'Row 73: Account Affiliation not found', 'Row 111: Duplicate website in payload', 'Row 166: Missing role assignment', 'Row 204: Site ID not linked to owner account'] }
        ]
      },
      {
        name: 'Calculators',
